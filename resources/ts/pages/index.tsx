...
export default function Index({ app_ver, php_ver }: Props): React.JSX.Element {
  const [count, setCount] = useState<number>(0);

  return (
    <>
      <Head title="Laravel + React + TS">
      ...
      <div className="bg-black font-sans text-white/50 antialiased">
          ...
          <div className="relative flex min-h-screen flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
            <div className="relative w-full max-w-2xl px-6 lg:max-w-7xl">
              <header className="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                <div className="flex gap-6 lg:col-start-2 lg:justify-center">
                  <svg
                  ...
                  <svg
                    className="h-12 w-auto animate-rotate fill-[#61DAFB] lg:h-16"
                    viewBox="0 0 24 24"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                  >
              ...
              <main className="flex flex-col justify-center">
                <button
                  ...
                  className="mx-auto cursor-pointer rounded-lg border border-solid border-transparent bg-[#1a1a1a] px-[1.2em] py-[0.6em] text-[1em] font-medium transition-colors delay-[250ms] hover:border-[#646cff]"
                >
                  Count is {count}
                </button>
                  ...
                  >
                    <div className="relative flex w-full flex-1 items-stretch">
                      <img
                        ...
                        className="block aspect-video h-full w-full flex-1 rounded-[10px] object-cover object-top drop-shadow-[0px_4px_34px_rgba(0,0,0,0.25)]"
                      />
              ...
              <footer className="py-16 text-center text-sm text-black dark:text-white/70">
                Laravel v{app_ver} (PHP v{php_ver})
              </footer>
            </div>
          </div>
        </div>
